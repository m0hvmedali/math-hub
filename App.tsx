...
const App: React.FC = () => {
    ...
    return (
        ...
        <TimerProvider>
            ...
            {user && (
                <div className="md:hidden fixed bottom-0 w-full glass-nav border-t border-[var(--glass-border)] z-[100] px-6 py-4 flex justify-between items-center bg-black/90 backdrop-blur-xl pb-safe">
                    ...
                    <a href="#/space" className="flex flex-col items-center gap-1 text-[var(--text-muted)] hover:text-brand-cyan transition-colors z-[100]">
