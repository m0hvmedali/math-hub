...
const FloatingSpotifyWidget: React.FC = () => {
  const { token, isConnected, currentTrack, login, pause, resume, skipNext, skipPrev, searchSpotify, playTrack, playPlaylist } = useSpotify();
